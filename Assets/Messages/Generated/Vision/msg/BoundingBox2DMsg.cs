...
namespace RosMessageTypes.Vision
{
    ...
    public class BoundingBox2DMsg : Message
    {
        ...
        {
            this.center = new Pose2DMsg();
            this.size_x = 0.0;
            this.size_y = 0.0;
        }

        public BoundingBox2DMsg(Pose2DMsg center, double size_x, double size_y)
        {
            this.center = center;
            this.size_x = size_x;
            this.size_y = size_y;
        ...
        {
            this.center = Pose2DMsg.Deserialize(deserializer);
